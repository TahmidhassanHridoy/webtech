        ...
        <table class="shop-items">
                ...
                <tr>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\yamaha\v2\BEARING.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\yamaha\v2\BRAKEPAD.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\yamaha\v2\CLUTCH PLATE.jpg">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\yamaha\v2\CYLINDER KIT.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\yamaha\v2\DISK BRAKE.jpg"  width="150" hight = "150">
                ...
                <tr>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\yamaha\v2\HEADLIGHT.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\yamaha\v2\image.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\yamaha\v2\images (1).jpg"  width="150" hight = "150">
                        <h2 class="item-title">front disk</h2>Price:<h4 class="item-price"> $250</h4><button class="btn btn-primary addbutton" type="btn">ADD TO CART</button></div></td>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\yamaha\v2\images (2).jpg"  width="150" hight = "150">
                        <h2 class="item-title">cylinder kit</h2>Price:<h4 class="item-price"> $250</h4><button class="btn btn-primary addbutton" type="btn">ADD TO CART</button></div></td>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\yamaha\v2\images (3).jpg"  width="150" hight = "150">
                ...
                <tr>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\yamaha\v2\images (4).jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\yamaha\v2\images (5).jpg"  width="150" hight = "150">
                        <h2 class="item-title">oil filter </h2>Price:<h4 class="item-price"> $250</h4><button class="btn btn-primary addbutton" type="btn">ADD TO CART</button></div></td>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\yamaha\v2\images.jpg" width="150" hight = "150">
                ...
                <tr>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\yamaha\v2\INDICATOR.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\yamaha\v2\METER.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\yamaha\v2\OIL FILTER.jpg" width="150" hight = "150">
                        <h2 class="item-title">oil filter</h2>Price:<h4 class="item-price"> $250</h4><button class="btn btn-primary addbutton" type="btn">ADD TO CART</button></div></td>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\yamaha\v2\tandem-rear-seat-yamaha-yzf-r15.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\yamaha\v2\ZBKYH16_1.jpg"  width="150" hight = "150">
