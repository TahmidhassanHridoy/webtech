        ...
        <table class="shop-items">
                ...
                <tr>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Tvs\striker\AIR FILTER.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Tvs\striker\BRAKE SHOE.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Tvs\striker\CABLE.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Tvs\striker\CHAIN.jpg"width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Tvs\striker\CLUTCH PLATE.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Tvs\striker\DISK BRAKE.png"  width="150" hight = "150">
                ...
                <tr>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Tvs\striker\HEADLIGHT.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Tvs\striker\images (1).jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Tvs\striker\images (2).jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Tvs\striker\images (4).jpg"  width="150" hight = "150">
                        <h2 class="item-title">headlight cover</h2>Price:<h4 class="item-price"> $250</h4><button class="btn btn-primary addbutton" type="btn">ADD TO CART</button></div></td>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Tvs\striker\images (5).jpg"  width="150" hight = "150">
                        <h2 class="item-title">helmet cover</h2>Price:<h4 class="item-price"> $250</h4><button class="btn btn-primary addbutton" type="btn">ADD TO CART</button></div></td>
                </tr>
                <tr>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Tvs\striker\images.jpg"  width="150" hight = "150">
                        <h2 class="item-title">striker</h2>Price:<h4 class="item-price"> $250</h4><button class="btn btn-primary addbutton" type="btn">ADD TO CART</button></div></td>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Tvs\striker\METER.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Tvs\striker\OIL FILTER.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Tvs\striker\png-clipart-front-wheel-drive-glider-spoke-bicycle-motorcycle-spare-parts-bicycle-vacuum-cleaner-thumbnail.png"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Tvs\striker\TVS-Stryker-125-removebg-preview.png"  width="150" hight = "150">
