     ...
     <nav class="navbar">
        ...
        <table class="shop-items">
                ...
                <tr>
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Bajaj\ns160\bajaj-bike-spare-parts-500x500.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Bajaj\ns160\BRAKE SHOE.png"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Bajaj\ns160\CHAIN KIT.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Bajaj\ns160\CHAIN SPOKE.jpg"  width="150" hight = "150">
                        <h2 class="item-title"> chain spoket</h2>Price:<h4 class="item-price"> $250</h4><button class="btn btn-primary addbutton" type="btn">ADD TO CART</button></div></td>
                </tr>
                <tr>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Bajaj\ns160\CLAUCH CABLE.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Bajaj\ns160\CYLINDER KIT.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Bajaj\ns160\DISK BRAKE.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Bajaj\ns160\HEAD LIGHT.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Bajaj\ns160\hqdefault.jpg"  width="150" hight = "150">
                ...
                <tr>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Bajaj\ns160\images (1).jpg"  width="150" hight = "150">
                        <h2 class="item-title">clutch holder</h2>Price:<h4 class="item-price"> $250</h4><button class="btn btn-primary addbutton" type="btn">ADD TO CART</button></div></td>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Bajaj\ns160\images.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Bajaj\ns160\INDICATOR.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Bajaj\ns160\major-master-cylinder-kit.png"  width="150" hight = "150">
                        <h2 class="item-title">drain nut</h2>Price:<h4 class="item-price"> $250</h4><button class="btn btn-primary addbutton" type="btn">ADD TO CART</button></div></td>
                </tr> 
                <tr>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Bajaj\ns160\METER.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Bajaj\ns160\minot-caliper-kit-ets.png"  width="150" hight = "150">
                        <h2 class="item-title">holder</h2>Price:<h4 class="item-price"> $250</h4><button class="btn btn-primary addbutton" type="btn">ADD TO CART</button></div></td>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Bajaj\ns160\OIL FILTER.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Bajaj\ns160\PRISTON RING.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\Bajaj\ns160\RIM.jpg"  width="150" hight = "150">
