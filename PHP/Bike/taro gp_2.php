        ...
        <table class="shop-items">
                ...
                <tr>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\tarogp\gp 2\2-2.jpg"  width="150" hight = "150">
                        <h2 class="item-title">gp 2</h2>Price:<h4 class="item-price"> $250</h4><button class="btn btn-primary addbutton" type="btn">ADD TO CART</button></div></td>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\tarogp\gp 2\AIR FILTER.jpg" width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\tarogp\gp 2\BRAKE PAD.jpg"  width="150" hight = "150">
                ...
                <tr>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\tarogp\gp 2\CABLE.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\tarogp\gp 2\download (1).jpg"  width="150" hight = "150">
                        <h2 class="item-title">gp 2 s</h2>Price:<h4 class="item-price"> $250</h4><button class="btn btn-primary addbutton" type="btn">ADD TO CART</button></div></td>
                </tr> 
                <tr>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\tarogp\gp 2\HEADLIGHT.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        ...
                        <h2 class="item-title">pillion cover</h2>Price:<h4 class="item-price"> $250</h4><button class="btn btn-primary addbutton" type="btn">ADD TO CART</button></div></td>
                    <td><div class="shop-item">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\tarogp\taro.jpg"  width="150" hight = "150">
                ...
                <tr>
                    <td><div class="shop-item">
                        ...
                        <h2 class="item-title">rim</h2></td></td>
                    <td><div class="shop-item">
