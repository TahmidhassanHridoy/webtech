        ...
        <table class="shop-items">
                ...
                <tr>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\runner\rt\AIR FILTER.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\runner\rt\BEARING.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\runner\rt\BRAKE SHOE.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\runner\rt\CHAIN.jpg"width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\runner\rt\CLAUTCH CABLE.jpg"  width="150" hight = "150">
                        <h2 class="item-title">chain cable</h2>Price:<h4 class="item-price"> $250</h4><button class="btn btn-primary addbutton" type="btn">ADD TO CART</button></div></td>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\runner\rt\CLAUTCH PLATE.jpg"  width="150" hight = "150">
                ...
                <tr>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\runner\rt\DISK BRAKE.webp"  width="150" hight = "150">
                        <h2 class="item-title">disk brake</h2>Price:<h4 class="item-price"> $250</h4><button class="btn btn-primary addbutton" type="btn">ADD TO CART</button></div></td>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\runner\rt\download (4).jpg"  width="150" hight = "150">
                        <h2 class="item-title">rt</h2>Price:<h4 class="item-price"> $250</h4><button class="btn btn-primary addbutton" type="btn">ADD TO CART</button></div></td>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\runner\rt\HEADLIGHT.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\runner\rt\images (1).jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\runner\rt\images (2).jpg"  width="150" hight = "150">
                ...
                <tr>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\runner\rt\images (3).jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\runner\rt\images (4).jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\runner\rt\images (5).jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\runner\rt\images.jpg"width="150" hight = "150">
                        h2 class="item-title">suspention</h2>Price:<h4 class="item-price"> $250</h4><button class="btn btn-primary addbutton" type="btn">ADD TO CART</button></div></td>
                </tr> 
                <tr>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\runner\rt\images.png"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\runner\rt\imgbin-front-wheel-drive-glider-spoke-bicycle-motorcycle-spare-parts-7zDdASnF40dR9izzEcAa1fE14_t.jpg"width="150" hight = "150"></td>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\runner\rt\INDECATOR.jpg"  width="150" hight = "150">
                    ...
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\runner\rt\METER.jpg"  width="150" hight = "150">
                        <h2 class="item-title">indicator</h2>Price:<h4 class="item-price"> $250</h4><button class="btn btn-primary addbutton" type="btn">ADD TO CART</button></div></td>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\runner\rt\OIL FILTER.jpg"  width="150" hight = "150">
                ...
                <tr>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\runner\rt\SPOKE.jpg"  width="150" hight = "150">
                        <h2 class="item-title">disk brake</h2>Price:<h4 class="item-price"> $250</h4><button class="btn btn-primary addbutton" type="btn">ADD TO CART</button></div></td>
                    <td><div class="shop-item">
                        <img class="item-image" src="\SparePartsMarket\Bike_img\runner\runner.jpg"  width="150" hight = "150">
